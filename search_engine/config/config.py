...
from search_engine.llm_provider.generic.base import ReasoningEfforts
...
class Config:
    ...
    def parse_llm(llm_str: str | None) -> tuple[str | None, str | None]:
        ...
        from search_engine.llm_provider.generic.base import _SUPPORTED_PROVIDERS
    ...
    def parse_embedding(embedding_str: str | None) -> tuple[str | None, str | None]:
        ...
        from search_engine.memory.embeddings import _SUPPORTED_PROVIDERS
