...
from multi_agent.agents import ChiefEditorAgent
import asyncio
import json
from search_engine.utils.enum import Tone
...
def open_task():
    ...
    if not task:
        raise Exception("No task found. Please ensure a valid task.json file is present in the multi_agent directory and contains the necessary task information.")
