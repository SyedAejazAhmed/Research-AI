...
export const SECTION_META = {
  ...
  references:        { label: 'References',             icon: '⑥', minRefs: 24, maxRefs: 30, ieee: '24–30 references target' },
};
...
export default function SectionSidebar({
  ...
  const formatLabel = 'IEEE Paper Format';
          ...
          return (
            ...
            >
              ...
              <div className="flex items-start gap-2.5">
                <div className={`mt-0.5 shrink-0 ${isActive ? 'text-emerald-400' : isApproved ? 'text-emerald-400' : isReady ? 'text-teal-400' : 'text-gray-600'}`}>
                  {isApproved ? (
                    <CheckCheck size={13} />
                  ) : isGenerating ? (
